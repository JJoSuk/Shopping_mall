...
<div class="container w-50 shadow rounded border p-5 mt-5">
	...
	<div class="mt-3 w-100 findIdPw">
		<div class="d-flex justify-content-between">
			<div><i class="fa fa-lock"></i> <a href="<c:url value="/member/idPwFind.do?find=id"/>">아이디</a><a href="<c:url value="/member/idPwFind.do?find=pw"/>">비밀번호 찾기</a></div>
			<div><i class="fa fa-user-plus"></i> <a href="<c:url value="/member/memberRegister.do"/>">회원가입</a></div>
		</div>
	</div>
</div>
