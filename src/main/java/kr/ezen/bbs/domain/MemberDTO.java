...
public class MemberDTO {
	...
	public MemberDTO(String id, String pw, String name, int age, Date birthday, String email, String tel, String zipcode,
	...
	public MemberDTO(int no, String id, String pw, String name, int age, Date birthday, String email, String tel, String zipcode,
					 String road_addr, String jibun_addr, String detail_addr) {
		super();
		this.no = no;
		this.id = id;
