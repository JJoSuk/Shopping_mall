      ...
      <section class="w-75 ps-5">
         ...
         <table class="table">
			...
			<c:forEach var="dto" items="${dtos}">
               <tr>
                  ...
                  <td>
                     <image src="<c:url value="/fileRepo/${dto.pImage}"/>" width="80px"/>
                  </td>
                  <td>${dto.pName}</td>
                  <td>${dto.pQty}개</td>
                  <td><fmt:formatNumber value="${dto.price}"/>원</td>
                  
                  <td><fmt:formatNumber value="${dto.totPrice}"/>원<br/>
               ...
               <tr>
                  <form action = "<c:url value="/cart/cartDelete.do?id=${sessionScope.loginDto.id}"/>" name="cartForm" method="post">
         ...
         <table class="table">
            ...
            <tbody>
               ...
               <tr>
                  <td>배송지 주소</td>
                  <td>${mDto.zipcode} ${mDto.road_addr} ${mDto.jibun_addr} ${mDto.detail_addr}</td>
               </tr>
               <tr>
                  <td>전화번호</td>
                  <td>${mDto.tel}</td>
